...
int TMVAProva( TString myMethodList = "" )
{
...
//       gSystem->Exec("curl -O http://root.cern.ch/files/tmva_class_example.root");
   ...
   std::cout << "--- TMVAClassification       : Using input file: " << sinput->GetName() << std::endl;
   // Register the training and test trees
   TString bname = "./output_quaggio_qcd_1M.root";
   TFile *binput = TFile::Open( bname );
   TTree *signalTree     = (TTree*)sinput->Get("tree");
